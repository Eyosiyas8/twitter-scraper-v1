...
driver = webdriver.Chrome(options=options, executable_path=r"/home/ubuntu/Documents/twitterProject/chromedriver/chromedriver")
...
def profile_scraper(username):
    ...
    df.to_csv('/home/ubuntu/Documents/twitterProject/csv_files/' + username + '.csv')
