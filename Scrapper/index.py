...
with open("/home/ubuntu/Documents/twitterProject/Authentication/Document.txt","r", encoding='utf-8') as file:
    lines = file.readlines()
    lines = [line.rstrip() for line in lines]
    for i in tqdm.tqdm(range(len(lines))):
        ...
        csv_file = "/home/ubuntu/Documents/twitterProject/csv_files/" + username + ".csv"
        csv_file1 = "/home/ubuntu/Documents/twitterProject/csv_files/raw_dump_" + username + ".csv"
        csv_file2 = "/home/ubuntu/Documents/twitterProject/csv_files/parent_tweet_" + username + ".csv"
        csv_file3 = "/home/ubuntu/Documents/twitterProject/csv_files/reply_to_" + username + ".csv"
        try:
            os.remove(csv_file1)
            os.remove(csv_file2)
            os.remove(csv_file3)
